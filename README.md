...
1. [How to draw a circle inside Square using single DIV in css?](#q-how-to-draw-a-circle-inside-square-using-single-div-in-css)
...
1. [Who maintains the CSS specifications? What do you understand by W3C?](#q-who-maintains-the-css-specifications-what-do-you-understand-by-w3c)
1. [Explain the difference between ```visibility: hidden;``` and ```display: none;```? What are the pros and cons of using ```display:none```?](#q-explain-the-difference-between-visibility-hidden-and-display-none-what-are-the-pros-and-cons-of-using-display-none)
1. [What is re-flow?](#q-what-is-re-flow)
...
1. [Does padding-top or padding-bottom has effect on inline element?](#q-does-padding-top-or-padding-bottom-has-effect-on-inline-element)
1. [Which one would you prefer among px, em % or pt and why?](#q-which-one-would-you-prefer-among-px-em-or-pt-and-why)
1. [Does padding-left or padding-right or margin-left or margin-right has effect on inline element?](#q-does-padding-left-or-padding-right-or-margin-left-or-margin-right-has-effect-on-inline-element)
1. [Describe pseudo-elements and discuss what they are used for.](#q-describe-pseudo-elements-and-discuss-what-they-are-used-for)
1. [In a HTML document the pseudo class :root always refers to the html element?](#q-in-a-html-document-the-pseudo-class-root-always-refers-to-the-html-element)
1. [What is pseudo element? what is pseudo class?](#q-what-is-pseudo-element-what-is-pseudo-class)
1. [The pseudo class :checked will select inputs with type radio or checkbox, but not <option> elements.](#q-the-pseudo-class-checked-will-select-inputs-with-type-radio-or-checkbox-but-not-option-elements)
1. [How to center align a div inside another div?](#q-how-to-center-align-a-div-inside-another-div)
1. [Explain the CSS “box model” and the layout components that it consists of. Provide some usage examples.](#q-explain-the-css-box-model-and-the-layout-components-that-it-consists-of-provide-some-usage-examples)
1. [Explain what elements will match each of the following CSS selectors:](#q-explain-what-elements-will-match-each-of-the-following-css-selectors)
1. [Explain the meaning of each of these CSS units for expressing length:](#q-explain-the-meaning-of-each-of-these-css-units-for-expressing-length)
1. [In CSS3, how would you select:](#q-in-css3-how-would-you-select)
1. [What is the purpose of the box-sizing property?](#q-what-is-the-purpose-of-the-box-sizing-property)
...
1. [What are the various clearing techniques and which is appropriate for what context? How works .clearfix?](#q-what-are-the-various-clearing-techniques-and-which-is-appropriate-for-what-context-how-works-clearfix)
1. [Does ```overflow: hidden``` create a new block formatting context?](#q-does-overflow-hidden-create-a-new-block-formatting-context)
1. [How would you approach fixing browser-specific styling issues?](#q-how-would-you-approach-fixing-browser-specific-styling-issues)
1. [What are your favorite image replacement techniques and which do you use when?](#q-what-are-your-favorite-image-replacement-techniques-and-which-do-you-use-when)
1. [How do you serve your pages for feature-constrained browsers? What techniques/processes do you use?](#q-how-do-you-serve-your-pages-for-feature-constrained-browsers-what-techniques-processes-do-you-use)
1. [What are the different ways to visually hide content (and make it available only for screen readers)?](#q-what-are-the-different-ways-to-visually-hide-content-and-make-it-available-only-for-screen-readers)
1. [How could you apply css rules specific to a media?](#q-how-could-you-apply-css-rules-specific-to-a-media)
1. [What is the use of ```@media only screen```?](#q-what-is-the-use-of-media-only-screen)
1. [Does the ```screen``` keyword apply to the device's physical screen or the browser's viewport?](#q-does-the-screen-keyword-apply-to-the-device-s-physical-screen-or-the-browser-s-viewport)
1. [Are you familiar with styling SVG?](#q-are-you-familiar-with-styling-svg)
1. [Can you give an example of an @media property other than screen?](#q-can-you-give-an-example-of-an-media-property-other-than-screen)
1. [How would you implement a web design comp that uses non-standard fonts?](#q-how-would-you-implement-a-web-design-comp-that-uses-non-standard-fonts)
1. [Explain how a browser determines what elements match a CSS selector?](#q-explain-how-a-browser-determines-what-elements-match-a-css-selector)
1. [What are the some pseudo classed u have used?](#q-what-are-the-some-pseudo-classed-u-have-used)
1. [How do you optimize css selectors?](#q-how-do-you-optimize-css-selectors)
1. [How can you load css resources conditionally?](#q-how-can-you-load-css-resources-conditionally)
1. [What are the properties related to box model?](#q-what-are-the-properties-related-to-box-model)
...
1. [Tell what each of these tags do, if there are alternatives, which are preferable, why?](#q-tell-what-each-of-these-tags-do-if-there-are-alternatives-which-are-preferable-why)
1. [What is At-Rule?](#q-what-is-at-rule)
1. [What is Combinator selector?](#q-what-is-combinator-selector)
1. [What is RuleSet?](#q-what-is-ruleset)
1. [Provide CSS so that three lines are displayed red, then green, then blue (2):](#q-provide-css-so-that-three-lines-are-displayed-red-then-green-then-blue-2)
1. [Provided following HTML and CSS, what will be displayed (1)?](#q-provided-following-html-and-css-what-will-be-displayed-1)
1. [What is Universal Selector?](#q-what-is-universal-selector)
1. [How can the gap under the image be removed?](#q-how-can-the-gap-under-the-image-be-removed)
1. [What is graceful degradation?](#q-what-is-graceful-degradation)
1. [What is progressive enhancement?](#q-what-is-progressive-enhancement)
1. [What is progressive rendering?](#q-what-is-progressive-rendering)
1. [What is an ```iframe``` and how it works?](#q-what-is-an-iframe-and-how-it-works)
1. [What is mobile-first? Can you explain the difference between coding a website to be responsive versus using a mobile-first strategy?](#q-what-is-mobile-first-can-you-explain-the-difference-between-coding-a-website-to-be-responsive-versus-using-a-mobile-first-strategy)
1. [What does Accessibility (a11y) mean?](#q-what-does-accessibility-a11y-mean)
1. [What is accessibility & ARIA role means in a web application?](#q-what-is-accessibility-aria-role-means-in-a-web-application)
1. [What is UI/UX?](#q-what-is-ui-ux)
1. [What is semantic?](#q-what-is-semantic)
1. [Why you would like to use semantic tag. Why Semantic HTML is Important?](#q-why-you-would-like-to-use-semantic-tag-why-semantic-html-is-important)
1. [Which of listed CSS properties are inherited?](#q-which-of-listed-css-properties-are-inherited)
1. [Which property is used to change the face of a font?](#q-which-property-is-used-to-change-the-face-of-a-font)
1. [Which property is used to make a font italic or oblique?](#q-which-property-is-used-to-make-a-font-italic-or-oblique)
1. [Which property is used to create a small-caps effect?](#q-which-property-is-used-to-create-a-small-caps-effect)
1. [Which property is used to increase or decrease how bold or light a font appears?](#q-which-property-is-used-to-increase-or-decrease-how-bold-or-light-a-font-appears)
1. [Which property is used to add or subtract space between the letters that make up a word?](#q-which-property-is-used-to-add-or-subtract-space-between-the-letters-that-make-up-a-word)
1. [Which property is used to add or subtract space between the words of a sentence?](#q-which-property-is-used-to-add-or-subtract-space-between-the-words-of-a-sentence)
1. [Which property is used to indent the text of a paragraph?](#q-which-property-is-used-to-indent-the-text-of-a-paragraph)
1. [Which property is used to align the text of a document?](#q-which-property-is-used-to-align-the-text-of-a-document)
1. [Which property is used to underline, overline, and strikethrough text?](#q-which-property-is-used-to-underline-overline-and-strikethrough-text)
1. [Which property is used to capitalize text or convert text to uppercase or lowercase letters?](#q-which-property-is-used-to-capitalize-text-or-convert-text-to-uppercase-or-lowercase-letters)
...
1. [Describe Floats and Flexbox and how each works. Why Flexbox is a better solution for web layouts?](#q-describe-floats-and-flexbox-and-how-each-works-why-flexbox-is-a-better-solution-for-web-layouts)
1. [What is the difference between ```em``` and ```rem``` units?](#q-what-is-the-difference-between-em-and-rem-units)
1. [What is the difference between ```span``` and ```div```?](#q-what-is-the-difference-between-span-and-div)
1. [What does !important mean in CSS?](#q-what-does-important-mean-in-css)
1. [What are optional closing tag? and why would u use it?](#q-what-are-optional-closing-tag-and-why-would-u-use-it)
1. [What is a self closing tag?](#q-what-is-a-self-closing-tag)
1. [How can u highlight text in html?](#q-how-can-u-highlight-text-in-html)
...
1. [Explain new features in CSS3?](#q-explain-new-features-in-css3)
