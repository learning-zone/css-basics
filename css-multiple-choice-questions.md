...
## Q. Among these selectors which selector has the highest specificity ranking for selecting the anchor link element?
...
## Q. CSS grid and flexbox are now becoming a more popular way to create page layouts. However, floats are still commonly used, especially when working with an older code base, or if you need to support older browser version. What are two valid techniques used to clear floats?
...
## Q. What is true of block and inline elements? (_Alternative_: Which statement about block and inline elements is true?)
...
## Q. In this example, according to cascading and specificity rules, what color will the link be?
...
## Q. In the following example, what color will paragraph one and paragraph two be? (_Alternative_: In this example, what color will paragraphs one and two be?)
...
## Q. Which of the following is true of the SVG image format? (_Alternative_: Which statement about the SVG image format is true?)
...
## Q. Which of the following is not a valid color value? (_Alternative:_ Which choice is not a valid color value?)
...
## Q. Which selector would select only internal links within the current page?
...
## Q. What is the recommended name you should give the folder that holds your project's images?
...
## Q. Which CSS will cause your links to have a solid blue background that changes to semitransparent on hover?
...
## Q. You can use the `___` pseudo-class to set a different color on a link if it was clicked on.
...
## Q. What is the correct order for listing different link states in a website so those states display correctly on the page?
...
## Q. For this code, what is the font color of the hypertext link?
...
## Q. Which choice will not set all links that include domain.com to pink?
...
## Q. Which choice uses the correct syntax for adding a hover pseudo class to <a> element ?
...
## Q. When these pseudo class selectors are applied to a link, what states will the styles be applied to?
